...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.ClaimId).HasName("PK__Claim__EF2E139B7064943B");
        ...
        {
            entity.HasKey(e => e.DepartmentId).HasName("PK__Departme__B2079BED4141A421");
        ...
        {
            entity.HasKey(e => e.DiagnosisId).HasName("PK__Diagnosi__0C54CC73D90E1954");
        ...
        {
            entity.HasKey(e => e.EncounterId).HasName("PK__Encounte__4278DD36A0B3C13A");
        ...
        {
            entity.HasKey(e => e.InsuranceId).HasName("PK__Insuranc__74231A240B84A663");
        ...
        {
            entity.HasKey(e => e.PatientId).HasName("PK__Patient__970EC3668153A88C");
            ...
            entity.HasIndex(e => e.Mrn, "UQ__Patient__C790FDB4FA65BF36").IsUnique();
        ...
        {
            entity.HasKey(e => e.ProcedureId).HasName("PK__Procedur__54C2E52DD6445C1F");
        ...
        {
            entity.HasKey(e => e.ProviderId).HasName("PK__Provider__B54C687D42B8644E");
